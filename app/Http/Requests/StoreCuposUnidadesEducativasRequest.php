...
class StoreCuposUnidadesEducativasRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'unidades_educativa_codigo' => [
                'required',
                'integer',
                'exists:unidades_educativas,codigo',
                function ($attribute, $value, $fail) {
                    if (\App\Models\CuposUnidadesEducativa::where('unidades_educativa_codigo', $value)->where('gestion', $this->input('gestion'))->exists()) {
                        $fail('La unidad educativa ya tiene cupos asignados para esta gestion.');
                    }
                }
            ],
